...
async function startNewWordsSession(chatId) {
    ...
    try {
        ...
        // Получаем 5 случайных не изученных слов
...
// Функция: Получение случайных не изученных слов
...
async function showUserStats(chatId) {
    ...
    try {
        ...
        // Статистика по гибридной системе
...
// Функции для обратной тренировки
async function startReverseTraining(chatId) {
    ...
    try {
        ...
        // Информационное сообщение о гибридной системе
        await bot.sendMessage(chatId,
...
async function checkTrainingAnswer(chatId, userAnswer) {
    ...
    try {
        ...
        // Получаем или создаем обратную карточку
...
async function showTrainingResult(chatId, state, word, isCorrect, userAnswer = '') {
    ...
    // Информация о прогрессе обеих карточек
...
// Функции для ручного ввода перевода
...
// Вспомогательные функции для гибридной системы
