...
function hasPreviousAudios(chatId, currentAudioUrl) {
    ...
    return chatAudios.some(audio => audio.url !== currentAudioUrl);
}
    ...
    if (data.startsWith('audio_')) {
        ...
        if (audioUrl && englishWord) {
            try {
                ...
                // Проверяем, есть ли предыдущие аудио в этом чате
                ...
                // Добавляем текущее аудио в историю
...
console.log('🤖 Бот запущен с умной системой предупреждений об автовоспроизведении');
